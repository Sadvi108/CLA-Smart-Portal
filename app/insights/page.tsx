  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100">AI-Powered Insights</h1>
          <p className="mt-1 text-sm text-muted-foreground dark:text-gray-400">Smart forecasts and recommendations to help you plan and act with confidence.</p>
        </div>
      </div>

      {/* Key Predictions */}
      <div className="grid gap-5 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <Card className="p-5 sm:p-6 rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
          <CardHeader className="p-0 pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm sm:text-base font-medium text-gray-900 dark:text-gray-100">Next Reload Prediction</CardTitle>
          ...
          <CardContent className="p-0">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground dark:text-gray-400 mt-1">Expected in June 2025</p>
        ...
        <Card className="p-5 sm:p-6 rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
          <CardHeader className="p-0 pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm sm:text-base font-medium text-gray-900 dark:text-gray-100">Payment Forecast (7 Days)</CardTitle>
          ...
          <CardContent className="p-0">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground dark:text-gray-400 mt-1">Expected by Oct 14, 2025</p>
            <div className="mt-3">
              <Progress value={68} className="h-2" />
              <p className="text-xs sm:text-sm text-muted-foreground dark:text-gray-400 mt-1">68% confidence level</p>
            </div>
          </CardContent>
        </Card>

        <Card className="p-5 sm:p-6 rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 md:col-span-2 lg:col-span-1 dark:bg-gray-800/70 dark:border-gray-700">
          <CardHeader className="p-0 pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm sm:text-base font-medium text-gray-900 dark:text-gray-100">Cash Flow Trend</CardTitle>
          ...
          <CardContent className="p-0">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground dark:text-gray-400 mt-1">Positive trend detected</p>
            <div className="mt-3 inline-flex items-center gap-2 rounded-md bg-green-50 px-2 py-1 text-green-700 dark:bg-green-900/20 dark:text-green-400">
              <ArrowUpRight className="h-3 w-3 sm:h-4 sm:w-4" />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="p-5 sm:p-6 rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
          <CardHeader className="p-0 pb-4">
            <CardTitle className="text-lg font-semibold text-gray-900 dark:text-gray-100">Reload Prediction vs Actual</CardTitle>
        ...
        <Card className="p-5 sm:p-6 rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
          <CardHeader className="p-0 pb-4">
            <CardTitle className="text-lg font-semibold text-gray-900 dark:text-gray-100">7-Day Payment Forecast</CardTitle>
            <CardDescription className="text-sm text-muted-foreground dark:text-gray-400">
      ...
      <div className="grid gap-5 sm:grid-cols-1 lg:grid-cols-2">
        <Card className="p-5 sm:p-6 rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
          <CardHeader className="p-0 pb-4">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-lg font-semibold text-gray-900 dark:text-gray-100">Smart Recommendations</CardTitle>
            </div>
          </CardHeader>
          <CardContent className="p-0">
        ...
        <Card className="p-5 sm:p-6 rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
          ...
          <CardContent className="p-0">
            <div className="space-y-4">
              <div className="flex flex-col gap-2 p-3 sm:p-4 border border-gray-200 dark:border-gray-600 dark:bg-gray-700/50 rounded-lg sm:flex-row sm:items-center sm:justify-between transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-700/70">
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-gray-900 dark:text-gray-100 text-sm sm:text-base">Top Performing Customer</p>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Evergreen Shipping Ltd.</p>
                </div>
              ...
              <div className="flex flex-col gap-2 p-3 sm:p-4 border border-gray-200 dark:border-gray-600 dark:bg-gray-700/50 rounded-lg sm:flex-row sm:items-center sm:justify-between transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-700/70">
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-gray-900 dark:text-gray-100 text-sm sm:text-base">Most Frequent Payer</p>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Ocean Logistics Co.</p>
                </div>
              ...
              <div className="flex flex-col gap-2 p-3 sm:p-4 border border-gray-200 dark:border-gray-600 dark:bg-gray-700/50 rounded-lg sm:flex-row sm:items-center sm:justify-between transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-700/70">
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-gray-900 dark:text-gray-100 text-sm sm:text-base">Needs Attention</p>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Maritime Express Inc.</p>
                </div>
      ...
      {/* Anomaly Detection */}
      <Card className="rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
        <CardHeader>
          <div className="flex items-center gap-2">
            <AlertTriangle className="h-5 w-5 text-orange-600 dark:text-orange-400" />
            <CardTitle className="text-gray-900 dark:text-gray-100">Anomaly Detection</CardTitle>
          </div>
          <CardDescription className="text-muted-foreground dark:text-gray-400">Unusual patterns detected in your account activity</CardDescription>
        </CardHeader>
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <Card className="rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
          <CardHeader>
            <CardTitle className="text-gray-900 dark:text-gray-100">Reload Amount Prediction</CardTitle>
            <CardDescription className="text-muted-foreground dark:text-gray-400">Historical vs predicted reload amounts</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
          <CardHeader>
            <CardTitle className="text-gray-900 dark:text-gray-100">7-Day Payment Forecast</CardTitle>
            <CardDescription className="text-muted-foreground dark:text-gray-400">Expected payment amounts for the next week</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={paymentForecast}>
      ...
      <Card className="rounded-xl border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700">
        <CardHeader>
          <div className="flex items-center gap-2">
            <Lightbulb className="h-5 w-5 text-blue-600 dark:text-blue-400" />
            <CardTitle className="text-gray-900 dark:text-gray-100">Smart Recommendations</CardTitle>
          </div>
          <CardDescription className="text-muted-foreground dark:text-gray-400">AI-generated suggestions to optimize your operations</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          {[
            ...
            <div key={index} className={`flex items-start gap-4 p-4 ${recommendation.bgColor} rounded-lg transition-colors duration-300 hover:bg-opacity-80`}>
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h4 className="font-semibold text-sm dark:text-gray-100">{recommendation.title}</h4>
