...
export default function FeedbackPage() {
  ...
  const getStars = (rating: number) => {
    return Array.from({ length: 5 }, (_, i) => (
      <Star key={i} className={`h-4 w-4 ${i < rating ? "fill-yellow-400 text-yellow-400 dark:fill-yellow-300 dark:text-yellow-300" : "text-gray-300 "}`} />
    ))
  }
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className=" ">
          <CardHeader>
            ...
            <CardDescription className="">Overall customer sentiment analysis</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className=" ">
          <CardHeader>
            <CardTitle className="">Feedback by Category</CardTitle>
            <CardDescription className="">Most common feedback topics</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
      ...
      <Card className=" ">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="">Customer Feedback</CardTitle>
              <CardDescription className="">Recent feedback from customers</CardDescription>
            </div>
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-sm ">{feedback.customer}</span>
      ...
      <Card className=" ">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="">AI Sentiment Insights</CardTitle>
          </div>
          <CardDescription className="">Automated analysis of customer feedback trends</CardDescription>
        </CardHeader>
