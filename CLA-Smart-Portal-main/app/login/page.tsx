...
export default function LoginPage() {
  ...
  return (
    <TooltipProvider>
      <div className="min-h-screen flex overflow-hidden bg-white transition-colors duration-300 pb-24 md:pb-28">

        {/* Left Half - Login Form with Blue Gradient */}
        <div className={`w-1/2 flex items-center justify-center p-8 relative transition-all duration-1000 ease-out ${leftPanelLoaded ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`} style={{ backgroundColor: '#0096FF' }}>
          {/* Animated background elements */}
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-40 -left-40 w-80 h-80 bg-blue-500/20 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-blue-700/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
          </div>
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                  ...
                  <div className={`space-y-2 transition-all duration-500 delay-800 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                    ...
                    <div className="relative group">
                      <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 transition-colors duration-200 group-focus-within:text-blue-600" />
                      <Input
                        id="username"
                        type="text"
                        ...
                        className="pl-10 h-12 border-gray-300 dark:border-gray-600 focus:border-blue-600 focus:ring-blue-600 rounded-lg transition-all duration-300 hover:border-blue-400 focus:scale-[1.01] bg-white dark:bg-gray-700 text-gray-900 dark:text-white leading-relaxed"
                        required
                        disabled={isLoading}
                      />
                    </div>
                  ...
                  <div className={`space-y-2 transition-all duration-500 delay-900 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                    ...
                    <div className="relative group">
                      <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 transition-colors duration-200 group-focus-within:text-blue-600" />
                      <Input
                        id="password"
                        ...
                        className="pl-10 pr-10 h-12 border-gray-300 dark:border-gray-600 focus:border-blue-600 focus:ring-blue-600 rounded-lg transition-all duration-300 hover:border-blue-400 focus:scale-[1.01] bg-white dark:bg-gray-700 text-gray-900 dark:text-white leading-relaxed"
                        required
                        disabled={isLoading}
                      />
                      <button
                    ...
                    <Popover open={branchOpen} onOpenChange={setBranchOpen}>
                      <PopoverTrigger asChild>
                        <Button
                          ...
                          className="w-full h-12 justify-between border-gray-300 dark:border-gray-600 hover:border-blue-400 focus:border-blue-600 focus:ring-blue-600 rounded-lg transition-all duration-300 hover:scale-[1.01] bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                          disabled={isLoading}
                        >
                            ...
                            <CommandGroup>
                              {branches.map((b) => (
                                <CommandItem
                                  ...
                                  className="text-gray-900 dark:text-white hover:bg-blue-50 dark:hover:bg-gray-700"
                                >
                                  <Check
                  ...
                  <div className={`flex items-center justify-between transition-all duration-500 delay-1100 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                    ...
                    <Button
                      type="button"
                      variant="link"
                      className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 p-0 h-auto font-medium transition-colors duration-200"
                      disabled={isLoading}
                    >
                      Forgot Password?
                    </Button>
                  ...
                  <div className={`transition-all duration-500 delay-1200 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                    <Button
                      type="submit"
                      className="w-full h-12 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className={`text-center transition-all duration-500 delay-1100 hover:scale-110 cursor-pointer ${rightPanelLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                      <Truck className="w-8 h-8 mx-auto mb-2 text-blue-300 transition-all duration-300 hover:text-blue-200" />
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className={`text-center transition-all duration-500 delay-1200 hover:scale-110 cursor-pointer ${rightPanelLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                      <Globe className="w-8 h-8 mx-auto mb-2 text-blue-300 transition-all duration-300 hover:text-blue-200" />
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className={`text-center transition-all duration-500 delay-1300 hover:scale-110 cursor-pointer ${rightPanelLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                      <BarChart3 className="w-8 h-8 mx-auto mb-2 text-blue-300 transition-all duration-300 hover:text-blue-200" />
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className={`text-center transition-all duration-500 delay-1400 hover:scale-110 cursor-pointer ${rightPanelLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                      <Shield className="w-8 h-8 mx-auto mb-2 text-blue-300 transition-all duration-300 hover:text-blue-200" />
      ...
      <div className={`fixed bottom-0 left-0 right-0 z-40 transition-all duration-700 ease-in-out ${
          ...
          <div className="max-w-7xl mx-auto px-6 py-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-6">
                  ...
                  <div className="text-lg font-bold text-white dark:text-gray-100 group-hover:text-blue-300 dark:group-hover:text-blue-400 transition-colors duration-300">
                    6,169
                  </div>
              ...
              <div className="flex-1 flex justify-center">
                <Button 
                  className="text-white px-6 py-1 text-sm rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 font-semibold"
                  style={{ backgroundColor: '#0096FF' }}
                >
                  eFeedback
                </Button>
        ...
        {/* Navigation Bar */}
        <div className="shadow-lg" style={{ backgroundColor: '#0096FF' }}>
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center justify-between py-2">
              {/* Left Navigation */}
              <div className="flex items-center space-x-6">
                <div className="flex items-center space-x-1 text-white dark:text-gray-300 hover:text-blue-100 dark:hover:text-blue-400 cursor-pointer transition-colors duration-300 group">
